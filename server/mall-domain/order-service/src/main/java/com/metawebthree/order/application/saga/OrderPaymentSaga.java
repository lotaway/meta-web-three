 ...
 * Handles the distributed transaction: Order Create -> Inventory Reserve ->
...
public class OrderPaymentSaga {
    ...
    public Long execute(Long userId, String remark, List<OrderApplicationService.OrderItemCreate> items,
        ...
        try {
            ...
            sagaOrchestrator.executeStep(sagaId, SagaStep.StepName.RESERVE_INVENTORY, reserveRequest,
                    req -> step2Result, req -> {
                        inventoryClient.releaseInventoryByOrderId(step2OrderId,
                                "Saga compensation - release inventory");
                        return null;
                    });
    ...
    public static class OrderCreatedData {
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || getClass() != o.getClass())
                return false;
            OrderCreatedData that = (OrderCreatedData) o;
        ...
        public String toString() {
            return "OrderCreatedData{orderId=" + orderId + ", userId=" + userId + ", totalAmount=" + totalAmount + "}";
        }
    }
    ...
    public static class OrderCompensationData {
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || getClass() != o.getClass())
                return false;
            OrderCompensationData that = (OrderCompensationData) o;
            return Objects.equals(orderId, that.orderId) && Objects.equals(userId, that.userId);
        }
        ...
        @Override
        public String toString() {
            return "OrderCompensationData{orderId=" + orderId + ", userId=" + userId + "}";
        }
    }
    ...
    public static class InventoryReserveRequest {
        ...
        public List<OrderApplicationService.OrderItemCreate> getItems() {
            return items;
        }

        public void setItems(List<OrderApplicationService.OrderItemCreate> items) {
            this.items = items;
        }
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || getClass() != o.getClass())
                return false;
            InventoryReserveRequest that = (InventoryReserveRequest) o;
        ...
        @Override
        public String toString() {
            return "InventoryReserveRequest{orderId=" + orderId + ", items=" + items + "}";
        }
    }
    ...
    public static class InventoryCompensationData {
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || getClass() != o.getClass())
                return false;
            InventoryCompensationData that = (InventoryCompensationData) o;
        ...
        @Override
        public String toString() {
            return "InventoryCompensationData{orderId=" + orderId + "}";
        }
    }
    ...
    public static class PaymentRequest {
        ...
        @Override
        public String toString() {
            return "PaymentRequest{orderId=" + orderId + ", userId=" + userId + ", amount=" + amount + "}";
        }
    }
    ...
    public static class PaymentCompensationData {
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || getClass() != o.getClass())
                return false;
            PaymentCompensationData that = (PaymentCompensationData) o;
            return Objects.equals(orderId, that.orderId);
        }
        ...
        @Override
        public String toString() {
            return "PaymentCompensationData{orderId=" + orderId + "}";
        }
    }
    ...
    public static class InventoryConfirmRequest {
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || getClass() != o.getClass())
                return false;
            InventoryConfirmRequest that = (InventoryConfirmRequest) o;
            return Objects.equals(orderId, that.orderId);
        }
        ...
        @Override
        public String toString() {
            return "InventoryConfirmRequest{orderId=" + orderId + "}";
        }
    }
}
