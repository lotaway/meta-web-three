...
public interface CryptoPriceRepository extends BaseMapper<CryptoPrice> {
    ...
    List<CryptoPrice> findByBaseCurrencyAndQuoteCurrency(@Param("baseCurrency") String baseCurrency,
    ...
    List<CryptoPrice> findBySymbolAndTimestampAfter(@Param("symbol") String symbol,
