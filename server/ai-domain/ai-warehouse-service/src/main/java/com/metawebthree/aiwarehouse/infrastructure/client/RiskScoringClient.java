...
public class RiskScoringClient extends AbstractAIClient {

    public RiskScoringClient(String endpoint, int timeoutMs, int retryCount) {
    ...
    protected AIResponse doInvoke(AIRequest request) {
        try {
            HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(URI.create(endpoint + "/api/v1/score"))
