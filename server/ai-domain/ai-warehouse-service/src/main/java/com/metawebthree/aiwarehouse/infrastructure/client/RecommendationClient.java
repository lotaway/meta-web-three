...
public class RecommendationClient extends AbstractAIClient {

    public RecommendationClient(String endpoint, int timeoutMs, int retryCount) {
    ...
    protected AIResponse doInvoke(AIRequest request) {
        try {
            HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(URI.create(endpoint + "/api/v1/recommend"))
