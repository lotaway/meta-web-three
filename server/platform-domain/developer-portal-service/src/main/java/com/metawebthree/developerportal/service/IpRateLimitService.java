...
public class IpRateLimitService {
    ...
    private static final String KEY_PREFIX = "metaweb:ratelimit:developer:";

    private final RedisTemplate<String, Object> redisTemplate;

    @Value("${service-governance.rate-limiter.developerRegister.limit-for-period:3}")
    private int maxRequests;

    @Value("${service-governance.rate-limiter.developerRegister.limit-refresh-period:60s}")
