...
public class TraceController {
    ...
    public ResponseEntity<TraceRecord> linkMaterial(@PathVariable Long id, @RequestBody LinkMaterialRequest req) {
        return ResponseEntity.ok(commandService.linkMaterial(id, req.getMaterialCode(), req.getBatchNo(), req.getQuantity()));
    }
    ...
    public ResponseEntity<List<TraceRecord>> listRecords(
        ...
        if (productCode != null) return ResponseEntity.ok(queryService.findRecordsByProduct(productCode));
        if (batchNo != null) return ResponseEntity.ok(queryService.findRecordsByBatch(batchNo));
        if (workOrderNo != null) return ResponseEntity.ok(queryService.findRecordsByWorkOrder(workOrderNo));
        if (sn != null) return ResponseEntity.ok(queryService.findRecordsBySn(sn));
    ...
    public ResponseEntity<TraceModel> createModel(@RequestBody CreateModelRequest req) {
        return ResponseEntity.ok(commandService.createModel(req.getModelCode(), req.getModelName(), req.getProductType()));
    }
    ...
    public ResponseEntity<List<TraceModel>> listModels(
        ...
        if (productType != null) return ResponseEntity.ok(queryService.findModelsByProductType(productType));
    ...
    public ResponseEntity<TraceDataScope> createDataScope(@RequestBody CreateDataScopeRequest req) {
        return ResponseEntity.ok(commandService.createDataScope(req.getScopeCode(), req.getScopeName(), req.getScopeType()));
    }

    @PutMapping("/data-scopes/{id}")
    public ResponseEntity<TraceDataScope> updateDataScope(@PathVariable Long id, @RequestBody UpdateDataScopeRequest req) {
    ...
    public static class CreateTraceRequest {
        private String traceCode; private String traceType; private String productCode;
        private String productName; private String batchNo; private String sn;
        private String source; private String workOrderNo;
    ...
    public static class LinkMaterialRequest {
        private String materialCode; private String batchNo; private Integer quantity;
    ...
    public static class LinkEquipmentRequest {
        private String equipmentCode; private String equipmentName;
    ...
    public static class LinkOperatorRequest {
        private String operatorCode; private String operatorName;
    ...
    public static class LinkQcRequest {
        ...
        public String getQcRecordCode() { return qcRecordCode; }
        public void setQcRecordCode(String qcRecordCode) { this.qcRecordCode = qcRecordCode; }
    }

    public static class CreateModelRequest {
        private String modelCode; private String modelName; private String productType;
    ...
    public static class UpdateModelRequest {
        private String modelName; private String productType;
        private Boolean enableBatch; private Boolean enableSn; private Boolean enableMaterial;
        private Boolean enableProcess; private Boolean enableQuality; private Boolean enableEquipment;
        public String getModelName() { return modelName; }
        public void setModelName(String modelName) { this.modelName = modelName; }
        public String getProductType() { return productType; }
        public void setProductType(String productType) { this.productType = productType; }
        ...
        public Boolean getEnableSn() { return enableSn; }
        public void setEnableSn(Boolean enableSn) { this.enableSn = enableSn; }
        public Boolean getEnableMaterial() { return enableMaterial; }
        public void setEnableMaterial(Boolean enableMaterial) { this.enableMaterial = enableMaterial; }
        public Boolean getEnableProcess() { return enableProcess; }
        public void setEnableProcess(Boolean enableProcess) { this.enableProcess = enableProcess; }
        public Boolean getEnableQuality() { return enableQuality; }
        public void setEnableQuality(Boolean enableQuality) { this.enableQuality = enableQuality; }
        public Boolean getEnableEquipment() { return enableEquipment; }
        public void setEnableEquipment(Boolean enableEquipment) { this.enableEquipment = enableEquipment; }
    }

    public static class CreateDataScopeRequest {
        private String scopeCode; private String scopeName; private TraceDataScope.DataScopeType scopeType;
        ...
        public TraceDataScope.DataScopeType getScopeType() { return scopeType; }
        public void setScopeType(TraceDataScope.DataScopeType scopeType) { this.scopeType = scopeType; }
    }

    public static class UpdateDataScopeRequest {
        private String scopeName; private Boolean isDefault;
        public String getScopeName() { return scopeName; }
        public void setScopeName(String scopeName) { this.scopeName = scopeName; }
