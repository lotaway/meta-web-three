...
//  the VoteTest
const sourceCode = fs.readFileSync(path.join(__dirname, "./VoteTest.sol"), "utf8").toString(),
    compiledCode = solc.compile(sourceCode);

console.log(compiledCode);

const contractName = "VoteTest",
    // abi = JSON.parse(fs.readFileSync(path.join(__dirname, "./VoteTest.abi")).toString()),
